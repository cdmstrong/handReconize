...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default = './model_exp/2022-11-12_15-37-16/ReXNetV1-size-256-loss-wing_loss-model_epoch-12.pth',
